...
import { of } from 'rxjs';
import { BusListAuditTrialComponent } from './bus-list-audit-trial.component';

describe('BusListAuditTrialComponent', () => {
  let component: BusListAuditTrialComponent;
  let fixture: ComponentFixture<BusListAuditTrialComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BusListAuditTrialComponent);
