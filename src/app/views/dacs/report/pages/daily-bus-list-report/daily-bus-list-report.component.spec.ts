...
import { of } from 'rxjs';
import { DailyBusListReportComponent } from './daily-bus-list-report.component';

describe('DailyBusListReportComponent', () => {
  let component: DailyBusListReportComponent;
  let fixture: ComponentFixture<DailyBusListReportComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DailyBusListReportComponent);
