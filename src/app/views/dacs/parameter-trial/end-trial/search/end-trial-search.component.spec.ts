...
describe('EndTrialSearchComponent', () => {
  ...
  const mockParamterModeList: IEndTrial[] = DummyData.end_trial_list;
  ...
  it('should create component', () => {
    expect(EndTrialSearchComponent).toBeTruthy();
  });
  ...
  it('should handle select all checkboxes', () => {
    ...
    component.dataSource = mockParamterModeList;
    component.checkAllHandler(mockEvent);
    expect(component.chkAll).toBeTrue();
    expect(component.selection.length).toBe(mockParamterModeList.length);
