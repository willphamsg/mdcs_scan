...
describe('MessageFileExportComponent', () => {
  ...
  beforeEach(() => {
    ...
    mockPaginationService.paginatedData$ = of(
      DummyData.message_file_export_data
    );
  ...
  it('should load data on initialization', () => {
    expect(component.dataSource).toEqual(DummyData.message_file_export_data);
  ...
  it('should deselect an individual file when unchecked', () => {
    const mockFile: IFile = DummyData.message_file_export_data[0];
