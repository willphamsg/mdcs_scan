...
@Component({
    selector: 'app-message-file-export',
    imports: [
        MatCardModule,
        MatIconModule,
        MatButtonModule,
    ...
    templateUrl: './message-file-export.component.html',
    styleUrl: './message-file-export.component.scss',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class MessageFileExportComponent implements OnInit, OnDestroy {
  ...
  exportHandler() {
    ...
    this.importExportService
      .sendExportRequest(count, this.dateSelected)
      .subscribe({
        next: value => {
          if (value.status === 200) {
  ...
  openView(data: any) {
    ...
    dialogRef.afterClosed().subscribe(() => {
      ...
      this.dataSource = [...successFiles, ...failedFiles];
      this.cdr.detectChanges();
    });
  }
