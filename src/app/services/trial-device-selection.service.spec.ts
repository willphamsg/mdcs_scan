...
import { TrialDeviceSelectionService } from './trial-device-selection.service';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('TrialDeviceSelectionService', () => {
  let service: TrialDeviceSelectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(TrialDeviceSelectionService);
