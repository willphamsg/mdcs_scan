...
describe('MaintenanceSharedService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [MaintenanceSharedService],
    });
  ...
  describe('getAuditLogItems', () => {
    it('should return dummy data if useDummyData is true', () => {
      environment.useDummyData = true;
      const expectedData: IAudtitLog[] = DummyData['audit-log-items'];

      service.getAuditLogItems().subscribe(data => {
        expect(data).toEqual(expectedData);
      });
    });
