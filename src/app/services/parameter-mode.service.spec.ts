...
import { ParameterModeService } from './parameter-mode.service';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('ParameterModeService', () => {
  let service: ParameterModeService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ParameterModeService);
