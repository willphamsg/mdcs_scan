...
export class NewParameterApprovalService {
  ...
  search(params: IParams): Observable<PayloadResponse> {
    if (environment?.useDummyData) {
      ...
      // return of(dummyData);
      console.log({ requestTrialParams: params });
      return this.http
  ...
  manage(params: INewParameterApproval[]): Observable<PayloadResponse> {
    return this.update(params);
  }

  add(params: INewParameterApproval[]): Observable<PayloadResponse> {
    if (environment?.useDummyData) {
      const dummyData: PayloadResponse = {
        status: 200,
        status_code: 'SUCCESS',
  ...
  update(params: INewParameterApproval[]): Observable<PayloadResponse> {
    if (environment?.useDummyData) {
      const dummyData: PayloadResponse = {
        status: 200,
        status_code: 'SUCCESS',
  ...
  delete(params: INewParameterApproval[]): Observable<PayloadResponse> {
    if (environment?.useDummyData) {
      const dummyData: PayloadResponse = {
        status: 200,
        status_code: 'SUCCESS',
