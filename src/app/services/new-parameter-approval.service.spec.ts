...
import { NewParameterApprovalService } from './new-parameter-approval.service';
import { provideHttpClient, withInterceptorsFromDi } from '@angular/common/http';

describe('NewParameterApprovalService', () => {
  let service: NewParameterApprovalService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(NewParameterApprovalService);
